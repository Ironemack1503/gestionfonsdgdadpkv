  ...
  try {
    ...
    switch (action) {
      ...
      case 'create': {
        ...
        const { mois, annee, designation, montant_prevu, montant_lettre, rubrique_id } = params;

        if (!mois || !annee || !designation || montant_prevu === undefined) {
          return new Response(
